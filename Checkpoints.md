...
- **主要變更與建置內容**：
  1. **方法二（認真學習）擔任志工時數精確化**：
     - 路徑卡片之擔任志工項目改為「需擔任 EQ 講師的助手 12 小時」，副說明精準對齊為「（每學年僅 6 次，下午 13:00~15:00）」。
     - 方法一（輕度學習）維持原設定：「需擔任 EQ 講師的助手 8 小時（每學期僅 4 次，下午 13:00~15:00）」。
  2. **報名表單保證金退費任務徽章同步**：
     - 勾選方法二時展開之任務徽章更新為「✔ 擔任志工:需擔任EQ講師的助手 12 小時」。
  3. **100% 雙目錄同步**：
     - 根目錄與 `web/` 目錄已完成 100% 雙向對齊。
